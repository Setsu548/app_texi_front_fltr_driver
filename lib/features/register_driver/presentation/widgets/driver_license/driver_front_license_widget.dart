...
class DriverFrontLicenseWidget extends ConsumerStatefulWidget {
  const DriverFrontLicenseWidget({super.key});

  @override
  ConsumerState<DriverFrontLicenseWidget> createState() =>
      _DriverFrontLicenseWidgetState();
}

class _DriverFrontLicenseWidgetState
    extends ConsumerState<DriverFrontLicenseWidget> {
        ...
        return ModalOptionsImagePicker(
          options: [
            ModalOptionImage(
              ...
              onTap: () {
                ref
                    .read(frontLicenseProvider.notifier)
  ...
  Widget build(BuildContext context) {
    final image = ref.watch(frontLicenseProvider);
    return Column(
