...
class DriverExpirationLicense extends ConsumerWidget {
  final TextEditingController controller;
  final String? Function(String?)? validator;
  const DriverExpirationLicense({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final date = ref.watch(licenseExpirationDateProvider);
    return Column(
          ...
          child: TextFormField(
            ...
            onTap: () async {
              ...
              if (pickedDate != null &&
                ...
                ref
                    .read(licenseExpirationDateProvider.notifier)
                    .setExpirationDate(pickedDate);
                controller.text = DatesUtilities.formatDate(pickedDate);
              } else {
                controller.clear();
                ref.invalidate(licenseExpirationDateProvider);
